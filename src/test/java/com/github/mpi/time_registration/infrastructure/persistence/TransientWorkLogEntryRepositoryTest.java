...
public class TransientWorkLogEntryRepositoryTest {
    ...
    public void shouldStoreAndLoadEntry() throws Exception {
        ...
        WorkLogEntry entry = new WorkLogEntry(id, Workload.of("25m"), new ProjectName("Manhattan"));
    ...
    private WorkLogEntry newEntryWithId(EntryID id) {
        return new WorkLogEntry(id, Workload.of("66h"), new ProjectName("doesn't matter"));
    }
